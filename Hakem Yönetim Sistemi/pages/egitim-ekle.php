        ...
        <div class="tab-icerik form-layout">
            <div class="card-body">
                <div class="form-group">
                    <label>Konu:</label>
                    <input type="text" name="konu" class="konu form-control form-control-solid" placeholder="Konu" />
                </div>
                ...
                <div class="form-group">
                    <label>Yer:</label>
                    <input type="text" name="yer" class="yer form-control form-control-solid" placeholder="Yer" />
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function(result) {
					...
					<div class="message` + i + `">
                        ...
                        setTimeout(function() {
                            $(mbox).hide(300);
                            location.href = "egitim-guncelle-"+getid;
                        }, 1000);
                        getid = split[2];
                        i += 1;
                    }
