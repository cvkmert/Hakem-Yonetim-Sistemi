...
<div class="page-title">
    <h1>Hakem Güncelle - <?php echo $ad_soyad; ?></h1>
</div>
    ...
    <div class="add-category product-category form-tab">
        <div class="tab-icerik form-layout">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label>Boy:</label>
                    <input type="text" value="<?php echo $boy; ?>" name="boy" class="boy form-control form-control-solid" placeholder="Boy" />
                </div>

                <div class="form-group">
                    <label>Kilo:</label>
                    <input type="text" value="<?php echo $kilo; ?>" name="kilo" class="kilo form-control form-control-solid" placeholder="Kilo" />
                </div>
    ...
    <script>
        ...
        function guncelle() {
           ...
           // var dogum_tarihi = $('.dogum-tarihi').val();
            ...
            $.ajax({
                url: "post.php?command=hakem-guncelle",
                type: "POST",
                dataType: 'script',
                cache: false,
                contentType: false,
