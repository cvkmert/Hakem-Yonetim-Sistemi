...
<div class="add-category">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" id="kt_select2_10" name="takim-2" class="takim-2">
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            $stadyum = $row['stadyum_adi'];
                            echo '<option value="' . $stadyum . '">' . $stadyum . '</option>';
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" id="kt_select2_3" name="takim-2" class="takim-2">
                        ...
                        while ($row = mysqli_fetch_array($query)) {
                            $hakem = $row['ad_soyad'];
                            echo '<option value="' . $hakem . '">' . $hakem . '</option>';
                        }
                        ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    <label>Lig:</label>
                    <input type="text" name="lig" id="lig" class="lig form-control form-control-solid" placeholder="Lig" />
                </div>
            </div>
    ...
    <script>
        ...
        function ekle() {
            ...
            $.ajax({
                url: "post.php?command=karsilasma-ekle",
                type: "POST",
                dataType: 'script',
                cache: false,
                contentType: false,
                ...
                success: function(result) {
					...
					<div class="message` + i + `">
                        ...
                        setTimeout(function() {
                            $(mbox).hide(300);
                            location.href = "karsilasma-guncelle-"+getid;
                        }, 1000);
                        getid = split[2];
                        i += 1;
                    }
