...
$query = mysqli_query($conn, "SELECT * FROM egitimler WHERE id = '$id'");
...
<div class="page-title">
    <h1>Eğitim Güncelle - <?php echo $konu; ?></h1>
</div>
<div class="add-category">
        ...
        <div class="tab-icerik form-layout">
            <div class="card-body">
                <div class="form-group">
                    <label>Konu:</label>
                    <input type="text" value="<?php echo $konu; ?>" name="konu" class="konu form-control form-control-solid" placeholder="Konu" />
                </div>
    ...
    <script>
        ...
        function guncelle() {
            ...
            $.ajax({
                url: "post.php?command=egitim-guncelle",
                type: "POST",
                dataType: 'script',
                cache: false,
                contentType: false,
